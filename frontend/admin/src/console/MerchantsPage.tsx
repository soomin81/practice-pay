...
export function MerchantsPage({ me }: { me: MeResponse }) {
	...
	return (
		<>
			<PageHeader title="가맹점" description="PG에 등록된 가맹점을 조회하고 새로 등록합니다." />
		<div className="flex flex-col gap-6">
			{canRegisterMerchant(String(me.role)) && (
				<Panel title={<>가맹점 등록</>} meta={<>가맹점과 최초 OWNER 계정을 함께 만듭니다. 가맹점은 스스로 가입할 수 없습니다.</>}>
					<div>
			...
			<Panel title={<>가맹점</>} meta={<>등록된 가맹점 목록입니다.</>}>
				<div>
