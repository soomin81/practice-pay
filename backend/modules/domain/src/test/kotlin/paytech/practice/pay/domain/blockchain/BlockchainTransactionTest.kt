...
private fun newTransaction(): BlockchainTransaction = BlockchainTransaction.create(
...
class BlockchainTransactionTest : FunSpec({
	...
	test("reconstitute restores a CONFIRMED transaction faithfully") {
		...
		val tx = BlockchainTransaction.reconstitute(
