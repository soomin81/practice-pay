...
private fun newReceivable(
	adjustmentAmount: SignedMoney = SignedMoney.ZERO,
): SettlementReceivable = SettlementReceivable.create(
...
class SettlementReceivableTest : FunSpec({
	...
	test("reconstitute restores a READY receivable faithfully") {
		...
		val receivable = SettlementReceivable.reconstitute(
