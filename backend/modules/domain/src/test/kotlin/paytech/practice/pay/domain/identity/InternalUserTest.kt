...
private fun bootstrapSuperAdmin(): InternalUser = InternalUser.bootstrap(
...
private fun invitedOperator(): InternalUser = InternalUser.invite(
...
class InternalUserTest : FunSpec({
